...
<input type="hidden" value="false" name="isFramed">
    ...
    <input type="hidden" name="innerWidth">
                ...
                <div class="paymentbuttons" id="paymentButtons">
                    <span> <p id="precarttext">Escolha o método de pagamento</p></span>
  ...
  <div id="footer">
    ...
    <div class="footer-menu">
      ...
      <div class="container merchant" id="merchantfooter">
          ...
          <nav class="col-xs-24">
            <ul>
                                                                                <li><a href="http://www.dhl.ch/de.html" target="_blank" data-test-selector="footerLink" rel="noopener">Startseite</a></li>
                                                                                                <li><a href="http://www.dhl.ch/de/rechtliche_hinweise.html#t_c" target="_blank" data-test-selector="footerLink" rel="noopener">Nutzungsbedingungen</a></li>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      </ul>
          </nav>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-xs-24" data-test-selector="privacyPolicyContainer" id="privacyPolicyContainer">
                                                <a href="https://payment.pay2.secured-by-ingenico.com/checkout/6742-3c6ca89d905040d3ae7e1a5d4871fa92:64be154f-0626-4068-993f-cb3ec16ebe73:3063e5608e0e4797938d333e66912794/privacy.html" target="_blank" rel="noopener"><span>Datenschutzrichtlinie</span></a>
                                          </div>
        </div>
      </div>
    </div>
